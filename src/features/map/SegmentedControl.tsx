...
export function SegmentedControl({ options, value, onChange, ariaLabel, wrap = false, className }: SegmentedControlProps) {
  ...
  const buttonCls = (active: boolean) =>
    wrap
      ? `min-h-9 px-2 py-1 font-mono text-[11px] rounded-sm border transition-colors cursor-pointer ${
          active
      ...
      : `flex-1 min-h-9 px-2.5 py-1 font-mono text-[11px] transition-colors cursor-pointer ${
